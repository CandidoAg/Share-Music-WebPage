...
SPOTIPY_CLIENT_ID = '75d293c5215d4a08ab6e54974abd81b0'
SPOTIPY_CLIENT_SECRET = '21d779d6a6be45db9d93a3dff0ad6c4e'
...
def home(request):
    return render(request, 'shareMusic/home.html', {})
...
def sign_in(request):
    ...
    return render(request, 'shareMusic/sign-in.html', {'results': tracks})
...
def after_sign_in(request):
    ...
    return render(request, 'shareMusic/after-sign-in.html', {'results': results['items']})